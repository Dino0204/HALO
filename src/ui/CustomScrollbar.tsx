...
export default function CustomScrollbar() {
  ...
  return (
    <div
      ...
      className="pointer-events-auto fixed top-[15vh] right-2.5 z-[100] h-[70vh] w-1 cursor-pointer rounded-[10px] bg-white/5"
    >
      <div
        className="absolute left-1/2 size-3 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#e8e0d0] shadow-[0_0_10px_rgba(232,224,208,0.5)] transition-[transform,background] duration-300 ease-out hover:scale-[1.3] hover:bg-white"
        style={{
          top: `${offset * 100}%`,
        }}
      />
