...
import { loadGwangjuRoads } from '@/shared/api/gwangjuRoads'
import { GWANGJU_LANDMARKS } from '../model/landmarks'
import {
  createGeumnamroPath,
  pathLength,
  pointAtDistance,
  type RoadFeatureCollection,
} from '@/entities/gwangju/model/geumnamroPath'
import { CEMETERY_POS, MBC_POS } from '@/entities/gwangju/model/landmarks'
